...
struct TrendingCoinDetails {
    ...
    let imagePlaceholder = AppIcon.questionMark.value
    var volatility: VolatilityInfo {
        return VolatilityInfo(type: .percentage, percentage: data.priceChangePercentage24h["krw"]!)
    }
}
